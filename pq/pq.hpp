...
public:
  ...
  virtual void Insert(const Data& data) = 0; // Copy of the value
  virtual void Insert(Data&& data) = 0; // Move of the value

  virtual void Change(const ulong index, const Data& newval) = 0; // Copy of the value
  virtual void Change(const ulong index, Data&& newval) = 0; // Move of the value
